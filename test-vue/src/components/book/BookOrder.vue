      ...
      <el-dialog :title="textMap[dialogStatus]"
        ...
        <el-form class="small-space"
          ...
          <el-form-item label="情况"
                        :label-width="formLabelWidth">
            <el-input v-model="tempOrder.situation"
                      auto-complete="off"></el-input>
          </el-form-item>
        </el-form>
        <div slot="footer"
...
export default {
  ...
  methods: {
    ...
    createBook () {
      this.$http
        .post('/bookorder/bookorder', {
          ...
          situation: this.tempOrder.situation
        })
        .then(response => {
    ...
    deleteBook () {
      this.$http
        .post('/bookorder/bookorderDelete', {
          id: this.tempOrder.id
        })
        .then(response => {
